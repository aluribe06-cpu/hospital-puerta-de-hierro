      ...
      <div className="neo-glass-panel p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-slate-400 font-mono">TOMOGRAFÍA, RESONANCIA Y HEMODINAMIA</span>
          </div>
          <h2 className="text-2xl font-black text-white">Estudios Radiológicos y Visor Médico</h2>
