      ...
      <div className="neo-glass-panel p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5 mb-1.5 flex-wrap">
            ...
            <span className="text-xs text-cyan-200 font-bold font-mono tracking-wider drop-shadow-sm">NOM-016-SSA3-2012 PROTOCOLOS QUIRÚRGICOS</span>
          </div>
          <h2 className="text-2xl font-black text-white tracking-tight drop-shadow-sm">Trazabilidad de Instrumental y Autoclaves</h2>
